...
class SvcView(QFrame):
    def __init__(self, app: QApplication, parent: QFrame = None, controller=None):
        ...
        self.svc_params_layout = QVBoxLayout()
        self.train_test_layout = QGridLayout()
        self.metrics_layout = QVBoxLayout()
        
        self.main_layout.addLayout(self.svc_params_layout, stretch=1)
    ...
    def _fill_hyperparams(self, ):
        ...
        self.svc_params_layout.addWidget(params_tuning_title)
        self.svc_params_layout.addLayout(title_layout)
        self.svc_params_layout.addWidget(scroll_area)
    ...
    def _manage_classifier_params_layout(self):
        ...
        # ---- REGULAR PARAMS
        n_param = 0
        for name, value in self.controller.get_fixed_default_svc_params().items():
            ...
            self.svc_params[name] = params_edit.text()
        ...
        # ---- CONNECT
        params_reload_btn.clicked.connect(self.controller.reload_svc_params)
    ...
    def _manage_train_test_layout(self):
        ...
        learn_save_btn.clicked.connect(lambda:
                                       ...
                                       parent_controller.load_path_and_update_edit(learn_save_edit,
    ...
    def update_svc_params_from_view(self):
        for name, value in self.controller.get_fixed_default_svc_params().items():
            self.svc_params[name] = self.widgets[f"params_{name}_edit"].text()