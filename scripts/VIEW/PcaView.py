...
class PcaView(ctk.CTkFrame):
    ...
    def manage_pca_tab(self):
        ...
        load_dataset_entry = ErrEntry(master=init_frame, state='disabled', textvariable=load_dataset_var)
    ...
    def axes_toplevel(self):
        ...
        ratio_switch = ctk.CTkSwitch(master=general_toplevel, state='readonly', text='Show components ratios',
                                     variable=ratio_var)
